    ...
    <div className="asa-markdown-content prose dark:prose-invert max-w-none">
      <ReactMarkdown
        ...
        components={{
          ...
          h1: ({ children }) => <h1 className="text-2xl font-bold font-sans text-[#2F3331] dark:text-[#E4E7E6] mt-6 mb-3 leading-snug">{children}</h1>,
          h2: ({ children }) => <h2 className="text-xl font-bold font-sans text-[#2F3331] dark:text-[#E4E7E6] mt-5 mb-2.5 leading-snug">{children}</h2>,
          h3: ({ children }) => <h3 className="text-lg font-bold font-sans text-[#2F3331] dark:text-[#E4E7E6] mt-4 mb-2 leading-snug">{children}</h3>,
          p: ({ children }) => <p className="text-sm text-[#2F3331] dark:text-[#E4E7E6] font-normal leading-relaxed mb-4">{children}</p>,
          ul: ({ children }) => <ul className="list-disc pl-5 mb-4 text-sm text-[#2F3331] dark:text-[#E4E7E6] font-normal space-y-1.5">{children}</ul>,
          ol: ({ children }) => <ol className="list-decimal pl-5 mb-4 text-sm text-[#2F3331] dark:text-[#E4E7E6] font-normal space-y-1.5">{children}</ol>,
