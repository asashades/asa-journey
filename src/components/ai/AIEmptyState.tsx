...
export default function AIEmptyState({ message }: AIEmptyStateProps) {
  return (
    <div className="flex flex-col items-center justify-center rounded-2xl border border-[#EEF0EF] bg-white p-8 text-center shadow-sm">
      ...
      <h3 className="font-serif text-lg font-bold text-[#2F3331]">Not Enough Entries</h3>
      <p className="mt-2 text-sm leading-relaxed text-[#6F7476] max-w-[360px]">
